...
变量的声明在任意代码执行前发生（类似于private String str这样的声明并不是可执行代码）
...
[Java编译时提示非法向前引用](https://segmentfault.com/q/1010000013356508)

[java 报错非法的前向引用](https://www.cnblogs.com/iamzhoug37/p/4306304.html)